...
<figure class="center">
  <a href="/assets/img/cosmographs/twopoint-pk.png" title="a graph diagram" alt="graph diagram">
  <p align="center" >
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="/assets/img/cosmographs/connect-compare3.png" title="example image" class="img-fluid rounded z-depth-0" %}
    </div>
</div>
<div class="caption">
